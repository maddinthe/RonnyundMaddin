...
public class Rechner {
	...
	public void reset() {																// Zurücksetzten der Variablen
		status = 1;																		// wechsle in Zustand 1 wenn reset aufgerufen wird
		zahl1 = 0;																		// wechsle in Zustand 1 wenn Zahl1 aufgerufen wird
		zahl2 = 0;																		// wechsle in Zustand 1 wenn Zahl2 = 0 aufgerufen wird
		oper = 0;																		// wechsle in Zustand 1 wenn oper = 0 aufgerufen wird
		nakom = 0;																		// wechsle in Zustand 1 wenn nakom = 0 aufgerufen wird
	...
	public double rechnen(double num1, double num2, char operand) {						// Anlegen der Methode rechnen als double mit den Variablen num1, num2 und operand
		double ergebnis = 0;															// Variable Ergebnis vom Typ double wird auf 0 gesetzt
		switch (operand) {
		case '+':																		// Fall "+"
			ergebnis = num1 + num2;														// Variable ergebnis ergibt sich aus num1 + num2
			break;
		case '-':																		// Fall "-"
			ergebnis = num1 - num2;														// Variable ergebnis ergibt sich aus num1 - num2
			break;
		...
		return ergebnis;																// gib errechnetes Ergebnis zurück
	}
}
